...
class SellerController extends Controller
{
    ...
    public function create()
    {
        ...
        $url = "https://connect.stripe.com/express/oauth/authorize?redirect_uri=https://laravel-stripe-connect.test/stripe&client_id=".config('services.stripe.connect')."&state=$session";
        // dd($session, config('services.stripe.connect'), $url);
        return redirect($url);
    }
